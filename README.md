...
![Imagen señalando la opcion Copy Zone ID.](/image/ZoneID.png?raw=true "Imagen señalando la opcion Copy Zone ID.")
...
![Imagen señalando la opcion Copy Zone ID.](/image/ScrapperPID.png?raw=true "Imagen señalando la opcion Copy Zone ID.")
